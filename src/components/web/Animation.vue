<template>
	<!-- css3动画集合，可根据class 引入对应的动画 -->
	<div class="animation-box">
		<ul>
			<li class="animated fade-in-normal">淡入</li>
			<li class="animated rotate-in-down-left">从左滚入</li>
			<li class="animated rotate-in-down-right">从右滚入</li>
			<li class="animated zoom-in">放大</li>
			<li class="animated zoom-in-down">下落放大</li>
			<li class="animated fade-in">弹性放大</li>
			<li class="animated expand-open">弹性缩小</li>
			<li class="animated fade-in-left">向右飞入</li>
			<li class="animated fade-in-right">向左飞入</li>
			<li class="animated fade-in-up">向上飞入</li>
			<li class="animated fade-in-down">向下飞入</li>
			<li class="animated rotate-in">旋转出现</li>
			<li class="animated flip-in-y">左右旋转</li>
			<li class="animated flip-in-x">上下翻转</li>
			<li class="animated light-speed-in">刹车</li>
			<li class="animated slide-right">向右滑入</li>
			<li class="animated slide-left">向左滑入</li>
			<li class="animated slide-up">向上滑入</li>
			<li class="animated slide-down">向下滑入</li>
			<li class="animated stretch-right">向右展开</li>
			<li class="animated stretch-left">向左展开</li>
			<li class="animated pull-up">向上展开</li>
			<li class="animated pull-down">向下展开</li>
		</ul>
	</div>
</template>
...
<style lang="scss">
	  .animation-box ul li{
		...
		//淡入
	  .fade-in-normal{
		 animation: 1000ms linear 600ms 1 normal both running fadeInNormal;
	  }
	  //向左滚入
	  .rotate-in-down-left{
		 animation: 1000ms linear 600ms 1 normal both running rotateInDownLeft;
	  }
	  //向右滚入
	  .rotate-in-down-right{
		 animation: 1000ms linear 600ms 1 normal both running rotateInDownRight; 
	  }
	  //放大
	  .zoom-in{
		 animation: 1000ms linear 600ms 1 normal both running zoomIn;
	  }
	  //下落放大
	  .zoom-in-down{
		 animation: 1000ms linear 600ms 1 normal both running zoomInDown;
	  }
	  //弹性放大
	  .fade-in{
		 animation: 1000ms linear 600ms 1 normal both running fadeIn;
	  }
	  //弹性缩小
	  .expand-open{
		 animation: 1000ms linear 600ms 1 normal both running expandOpen; 
	  }
	  //向右飞入
	  .fade-in-left{
		 animation: 1000ms linear 600ms 1 normal both running fadeInLeft;
	  }
	  //向左飞入
	  .fade-in-right{
		 animation: 1000ms linear 600ms 1 normal both running fadeInLeft;
	  ...
	  //向上飞入
	  .fade-in-up{
		 animation: 1000ms linear 600ms 1 normal both running fadeInUp;
	  }
	  //向下飞入
	  .fade-in-down{
		 animation: 1000ms linear 600ms 1 normal both running fadeInDown;
	  }
	  //旋转出现
	  .rotate-in{
		 animation: 1000ms linear 600ms 1 normal both running rotateIn;
	  }
	  //左右旋转
	  .flip-in-y{
	  	 animation: 1000ms linear 600ms 1 normal both running flipInY;
	  }
	  //上下旋转
	  .flip-in-x{
	  	 animation: 1000ms linear 600ms 1 normal both running flipInX; 
	  }
	  //刹车
	  .light-speed-in{
	  	 animation: 1000ms linear 600ms 1 normal both running lightSpeedIn;
	  }
	  //向右滑入
	  .slide-right{
	  	 animation: 1000ms linear 600ms 1 normal both running slideRight;
	  }
	  //向左滑入
	  .slide-left{
	  	 animation: 1000ms linear 600ms 1 normal both running slideLeft;
	  }
	  //向上滑入
	  .slide-up{
	  	 animation: 1000ms linear 600ms 1 normal both running slideUp;
	  }
	  //向下滑入
	  .slide-down{
	  	 animation: 1000ms linear 600ms 1 normal both running slideDown;
	  }
	  //向右展开
	  .stretch-right{
	  	 animation: 1000ms linear 600ms 1 normal both running stretchRight; 
	  }
	  //向左展开
	  .stretch-left{
	  	 animation: 1000ms linear 600ms 1 normal both running stretchLeft;
	  }
	  //向上展开
	  .pull-up{
	  	 animation: 1000ms linear 600ms 1 normal both running pullUp; 
	  }
	  //向下展开
	  .pull-down{
	  	 animation: 1000ms linear 600ms 1 normal both running pullDown; 
	  }
	 .animated {
